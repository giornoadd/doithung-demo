      ...
      <div className="max-w-7xl mx-auto px-5 py-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-lg font-semibold text-gray-700">AI Processing Dashboard</h1>
          </div>
        </div>
        <Link href="/" className="text-sm font-medium text-[#006A4E] hover:text-[#009688] transition-base">← Back to Hub</Link>
      </div>
    </header>
  );
}
